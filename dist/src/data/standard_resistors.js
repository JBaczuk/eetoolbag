...
var ResistorSet = /** @class */ (function () {
    function ResistorSet(tolerance, resistances) {
        this.tolerance = tolerance;
        this.resistances = this.populate_resistor_values(resistances);
    }
    ResistorSet.prototype.populate_resistor_values = function (values) {
        var final_array = [];
...
exports.ResistorSet = ResistorSet;
exports.default = [
